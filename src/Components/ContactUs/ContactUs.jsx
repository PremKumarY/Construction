    ...
    <section id="contact" className="bg-gray-100 dark:bg-gray-900 py-16 px-4 sm:px-6 lg:px-8 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="rounded-lg overflow-hidden shadow-md">
          <iframe className="w-full h-96 meramap rounded-lg" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5341224.87104432!2d75.2782142347963!3d22.3511148131866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDIxJzA0LjAiTiA3NMKwMTYnMzQuMCJF!5e0!3m2!1sen!2sin!4v1719339351012!5m2!1sen!2sin" allowFullScreen="" loading="lazy"></iframe>
        </div>
      </div>
    </section>
  );
