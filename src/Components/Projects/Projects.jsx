...
const ProjectSection = () => {
  ...
  return (
    <section id="projects" className="bg-orange-500 dark:bg-gray-700 py-16 duration-1000">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-extrabold mb-4 text-white dark:text-[#5ee6e6] text-center">
          Our Featured Projects
        </h2>
        <div>
        <p className="text-lg text-white  text-center dark:text-white-700 mb-12">
