...
const BlogSection = () => {
  ...
  return (
    <section
      id="blog"
      className="bg-orange-500 dark:bg-gray-500 py-16 duration-1000"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-white dark:text-[#5ee6e6] mb-6 text-center">
          Our Latest Blogs
        </h2>
        <p className="text-lg text-white  text-center dark:text-white-600 mb-10">
